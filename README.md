# CYTO-SV-ML
## Introduction
CYTO-SV-ML is a snakemake based workflow for calling, quality control, annotations, and classification (germline/somatic) of strucutural variations from whole genome sequencing data. It's integrated multiple SV callers (Delly/Breakdancer/CNVnator/Manta/Lumpy/ichorCNV) from Parliament2 and Chromoseq pipelines. Empowered by a collection of Public SV databases (DGV (http://dgv.tcag.ca), gnomAD (http://gnomad.broadinstitute.org/help/sv-overview), 1000 Genomes (http://www.internationalgenome.org/phase-3-structural-variant-dataset), CytoAtlas (http://atlasgeneticsoncology.org), and COSMIC (http://cancer.sanger.ac.uk/cosmic)), benchmarking SV data have been produced via comprehensive annotation and filtering algorithms. IN two MDS patient cohorts (494/94), it's achieved > 0.90 AUC and retrieved cytogenetic informations in 11% patients whose clinical records are missing. 
